...
# 2. RunCountThrees: This is a target that launches the executable
...
# Enter make runCountThrees to execute the CountThrees file.
...
CountThrees:
	...
	$(CC) -o CountThrees readInt32BitLE.o countThrees.o 

# RunCountThrees Description: 
# This target depends on the existence of the executable CountThrees
# and threesData.bin. 

runCountThrees: CountThrees threesData.bin
	./CountThrees
...
clean:
	rm -rf CountThrees readInt32BitLE.o countThrees.o 
